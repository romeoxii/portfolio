    ...
    <div>
        ...
        >
            <div class="bg-white rounded-full">
                <button
                    class="p-2 border border-black/30 text-black/70 shadow-sm rounded-full transition-all duration-600 hover:scale-105 ease-in-out"
                    :class="
                        theme === 'dark'
                            ? 'bg-neutral-600 text-neutral-50 border border-neutral-200'
                            : 'bg-neutral-50'
                    "
                    @click="toggle"
                >
        ...
        >
            <Transition name="modal" appear
                ><div
                    v-if="navBar"
                    class="max-w-sm w-full h-30 border border-black/20 rounded-2xl relative top-[10%] left-0 flex items-center justify-center p-3"
                    :class="
                        theme === 'dark'
                            ? 'bg-neutral-800 border-dotted border-neutral-400'
                            : 'bg-neutral-50'
                    "
                >
                            ...
                            <RouterLink
                                ...
                                ><button
                                    ...
                                    :class="[
                                        ...
                                        isActive(nav.path) &&
                                            'rounded-full text-blue-400 border-black/30',
                                    ]"
                                >
