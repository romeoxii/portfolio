...
<template>
    <div
        class="flex items-center justify-between gap-2 p-1.5 rounded-3xl border border-neutral-400 bg-neutral-100 shadow-lg"
        :class="theme === 'dark' ? ' bg-neutral-700 border-neutral-50' : ''"
    >
        <button
            class="rounded-full p-1 text-blue-400"
            :class="theme === 'dark' ? ' bg-neutral-500 text-white' : ' '"
        ...
        <button
            class="rounded-full p-1 text-blue-400"
            :class="theme === 'light' ? ' bg-neutral-500 text-white' : ' '"
