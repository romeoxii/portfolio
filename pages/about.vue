    ...
    >
        <div class="h-full md:w-4xl w-full md:p-6">
            <div class="h-full w-full flex flex-col justify-between space-y-3">
                <div
                    class="w-full flex flex-col justify-between md:p-8 py-4 space-y-5"
                >
                    <h1 class="text-3xl font-bold md:mt-5 mt-7">
                        Hi, Romeo here
                    </h1>
                    <div class="md:text-[11.5px] text-sm">
                        <p>Introvert by nature, web developer by passion.</p>
                        <p>
                            Eager to build things that speak louder than I do,
                            using
                            ...
                            <span class="text-sky-500 font-medium"
                                >Tailwind CSS</span
                            >, and lately,
                            <span class="text-[#028A0F] font-medium"
                                >Nuxt.js</span
                            >.
                        </p>
                        <p>
                            My happy place? A quiet mid-lit room, some lo-fi
                            beats, and a UI that just feels right. I love clean
                            design, smooth flows, and websites that don't need
                            instructions.
                        </p>
                    </div>
                    <p class="pb-8 pt-4 md:text-[11.5px] text-sm">
                        When I'm not coding, I'm probably rewatching my favorite
                        anime, reading a book (just picked this up out of
                        nowhere), or just enjoying some quiet time offline.
                    </p>
                    ...
                    <div class="">
                        ...
                        <p class="md:text-[11.5px] text-sm">
                            I don't really have a stack per say but maybe
                            that'll be revealed when I dive deeper into ths
                            niche or get more curious about how things work, but
                            for now my go-to for front-end is
                            <span class="text-green-600 font-medium"
                                >Vue.js</span
                            >
