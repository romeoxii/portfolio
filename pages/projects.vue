        ...
        <div class="h-full md:w-4xl w-full md:p-6">
            <div class="flex flex-col items-center h-full w-full md:p-3">
                <div class="w-full mt-18 md:mt-8 mb-8">
                    <h1 class="text-7xl font-extrabold mb-6 text-gray-800/90">
                        Projects
                    </h1>
                    <p class="text-sm fonts-light text-black/70">
                        Explore my portfolio, where captivating design ideas are
                        brought to life, a place where passion meets curiosity
                        to shape projects I'm truly proud of.
                    </p>
                </div>
                <div
                    class="h-full w-full md:p-3 flex flex-col rounded-3xl border border-gray-300 p-4"
                >
